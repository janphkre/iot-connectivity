...
@Deprecated("Use SimpleConnectionProvider instead!")
abstract class DeprecatedSimpleConnectionProvider(private val deviceHost: String) : DeviceConnectionProvider {
