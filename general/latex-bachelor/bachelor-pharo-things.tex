...
\begin{document}
    ...
    \begin{thebibliography}{9}
        ...
        \bibitem[AOA Proxy]{aoaProxy}\texttt{https://github.com/timotto/AOA-Proxy}
        ...
        \bibitem[NFC Sockets Client]{nfcSocketsClient}\texttt{https://github.com/classycodeoss/nfc-sockets/blob/\linebreak master/android/NFCSockets/app/src/main/java/com/classycode/\linebreak nfcsockets/sockets/NFCSocket.java}
        \bibitem[NFC Sockets Server]{nfcSocketsServer}\texttt{https://github.com/classycodeoss/nfc-sockets/blob/\linebreak master/pn532\_socket\_tunnel/pn532\_socket\_tunnel.c}
