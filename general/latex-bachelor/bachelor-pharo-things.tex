...
\begin{document}
    ...
    \begin{thebibliography}{9}
        ...
        \bibitem[AOA Proxy Server]{aoaProxyAccessory}\texttt{https://github.com/timotto/AOA-Proxy/blob/\linebreak master/src/accessory.c} (Zeilen 131\&137)
        ...
        \bibitem[ITU Study Group]{ituGroup}\texttt{https://www.itu.int/en/ITU-T/about/groups/Pages/\linebreak sg20.aspx}
        ...
        \bibitem[NFC Sockets Client]{nfcSocketsClient}\texttt{https://github.com/classycodeoss/nfc-sockets/blob/\linebreak master/android/NFCSockets/app/src/main/java/com/classycode/\linebreak nfcsockets/sockets/NFCSocket.java} (Zeilen 467-475)
        \bibitem[NFC Sockets Server]{nfcSockets}\texttt{https://github.com/classycodeoss/nfc-sockets/blob/\linebreak master/pn532\_socket\_tunnel/pn532\_socket\_tunnel.c} (Zeilen 113-167)
