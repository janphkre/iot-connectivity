...
\begin{document}
    ...
    \begin{thebibliography}{9}
        ...
        \bibitem[NFC Sockets Client]{nfcSocketsClient}\texttt{https://github.com/classycodeoss/nfc-sockets/blob/master/android/NFCSockets/app/src/main/java/com/classycode/nfcsockets/sockets/NFCSocket.java}
