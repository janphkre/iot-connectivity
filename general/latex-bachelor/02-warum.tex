\section{Warum p2p?}
    ...
    Ein klassisches Client/Server-Modell sieht hierbei vor, dass auszuführende Berechnungen so aufgeteilt werden, dass ein Server Daten konsistent verwalten kann und in der Lage ist, diese Clients anzubieten. \footnote{QUELLE}
