\section{Mögliche Kommunikationstechnologien}
    ...
    \subsection{Kommunikation über Bluetooth}
        ...
        Bluetooth lehnt sich mit dem {\it Bluetooth Core} nur lose an das OSI-Referenzmodell an \footnote{TODO: Sauter}
        ...
        Dies wird ermöglicht, indem Broadcasts definiert werden, die Daten enthalten können. \footnote{TODO}
